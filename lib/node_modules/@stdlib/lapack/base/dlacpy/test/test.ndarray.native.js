...
tape( 'the function copies all of a matrix `A` to another matrix `B` (row-major)', function test( t ) {
	...
	out = dlacpy( str2enum( 'all' ), 2, 3, A, 3, 1, 1, B, 3, 1, 3 );
	...
	out = dlacpy( str2enum( 'all' ), 2, 3, A, -3, -1, 6, B, 3, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'all' ), 3, 2, A, 2, 1, 1, B, 2, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function copies part of a matrix `A` to another matrix `B` (row-major, upper)', opts, function test( t ) {
	...
	out = dlacpy( str2enum( 'upper' ), 2, 3, A, 3, 1, 1, B, 3, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'upper' ), 2, 3, A, 3, -1, 3, B, 3, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'upper' ), 3, 2, A, 2, 1, 1, B, 2, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function copies part of a matrix `A` to another matrix `B` (row-major, lower)', opts, function test( t ) {
	...
	out = dlacpy( str2enum( 'lower' ), 2, 3, A, 3, 1, 1, B, 3, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'lower' ), 2, 3, A, -3, 1, 4, B, 3, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'lower' ), 3, 2, A, 2, 1, 1, B, 2, 1, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function copies all of a matrix `A` to another matrix `B` (column-major)', function test( t ) {
	...
	out = dlacpy( str2enum( 'all' ), 2, 3, A, 1, 2, 1, B, 1, 2, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'all' ), 2, 3, A, 1, 2, 1, B, -1, -2, 8 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'all' ), 3, 2, A, 1, 3, 1, B, 1, 3, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function copies part of a matrix `A` to another matrix `B` (column-major, upper)', opts, function test( t ) {
	...
	out = dlacpy( str2enum( 'upper' ), 2, 3, A, 1, 2, 1, B, 1, 2, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'upper' ), 2, 3, A, 1, 2, 1, B, -1, 2, 4 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'upper' ), 3, 2, A, 1, 3, 1, B, 1, 3, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function copies part of a matrix `A` to another matrix `B` (column-major, lower)', opts, function test( t ) {
	...
	out = dlacpy( str2enum( 'lower' ), 2, 3, A, 1, 2, 1, B, 1, 2, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'lower' ), 2, 3, A, 1, 2, 1, B, 1, -2, 7 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
	...
	out = dlacpy( str2enum( 'lower' ), 3, 2, A, 1, 3, 1, B, 1, 3, 3 );
	t.strictEqual( out, B, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function copies all of a matrix `A` to another matrix `B` (column-major, lower, complex access patterns)', function test( t ) {
	...
	out = dlacpy( str2enum( 'all' ), 3, 3, A, 2, 6, 7, B, 2, 6, 7 );
	t.strictEqual( out, B, 'returns expected value' );
