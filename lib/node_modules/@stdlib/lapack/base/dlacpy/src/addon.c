...
static napi_value addon( napi_env env, napi_callback_info info ) {
	...
	STDLIB_NAPI_ARGV_STRIDED_FLOAT64ARRAY( env, B, M*N, 1, argv, 6 );

	API_SUFFIX(c_dlacpy)( order, uplo, M, N, A, LDA, B, LDB );
...
static napi_value addon_method( napi_env env, napi_callback_info info ) {
	...
	STDLIB_NAPI_ARGV_STRIDED_FLOAT64ARRAY( env, B, M*N, 1, argv, 7 );
