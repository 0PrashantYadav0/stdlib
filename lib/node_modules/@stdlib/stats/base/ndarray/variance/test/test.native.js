...
tape( 'the function supports single-precision floating-point ndarrays', opts, function test( t ) {
	...
	v = variance( [ new ndarray( 'float32', x, [ x.length ], [ 1 ], 0, 'row-major' ), correction ] );
	expected = 53.5 / (x.length-1);
	t.strictEqual( v, expected, 'returns expected value' );
...
tape( 'the function supports integer ndarrays', opts, function test( t ) {
	...
	v = variance( [ new ndarray( 'int32', x, [ x.length ], [ 1 ], 0, 'row-major' ), correction ] );
	expected = 53.5 / (x.length-1);
	t.strictEqual( v, expected, 'returns expected value' );
...
tape( 'the function supports ndarrays having a data type which is not supported by the native add-on (e.g., `generic`)', opts, function test( t ) {
	...
	v = variance( [ new ndarray( 'generic', x, [ x.length ], [ 1 ], 0, 'row-major' ), correction ] );
	expected = 53.5 / (x.length-1);
	t.strictEqual( v, expected, 'returns expected value' );
