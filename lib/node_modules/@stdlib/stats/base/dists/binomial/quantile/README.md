...
Returns the [quantile function][quantile-function] for a [binomial][binomial-distribution] distribution with number of trials `n` and success probability `p` at value `r`.

```c
double out = stdlib_base_dists_binomial_quantile( 0.4, 20, 0.2 );
// returns 3
```

The function accepts the following arguments:

-   **r**: `[in] int` input probability.
