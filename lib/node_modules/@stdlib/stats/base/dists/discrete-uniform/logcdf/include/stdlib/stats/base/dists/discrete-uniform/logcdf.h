...
#endif
/**
* Returns the natural logarithm of the cumulative distribution function (CDF) of a discrete uniform distribution with parameters `a` (minimum support) and `b` (maximum support).
*/
