...
#ifndef STDLIB_STATS_BASE_DISTS_DISCRETE_UNIFORM_KURTOSIS_H
#define STDLIB_STATS_BASE_DISTS_DISCRETE_UNIFORM_KURTOSIS_H
...
#endif // !STDLIB_STATS_BASE_DISTS_DISCRETE_UNIFORM_KURTOSIS_H
