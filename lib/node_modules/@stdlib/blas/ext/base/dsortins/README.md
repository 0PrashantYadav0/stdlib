...
```c
stdlib_strided_dsortins( const CBLAS_INT N, const double order, double *X, CBLAS_INT strideX );
```
...
```c
stdlib_strided_dsortins_ndarray( const CBLAS_INT N, const double order, double *X, CBLAS_INT strideX, CBLAS_INT offsetX );
```
