...
*/
void API_SUFFIX(stdlib_strided_dsortins)( const CBLAS_INT N, const double order, double *X, CBLAS_INT strideX) {
	CBLAS_INT ox = stdlib_strided_stride2offset( N, strideX );
	return API_SUFFIX(stdlib_strided_dsortins_ndarray)( N, order, X, strideX, ox );
}
...
*/
void API_SUFFIX(stdlib_strided_dsortins_ndarray)( const CBLAS_INT N, const double order, double *X, CBLAS_INT strideX, CBLAS_INT offsetX ) {
	CBLAS_INT ix;
	CBLAS_INT jx;
	CBLAS_INT fx;
	CBLAS_INT lx;
